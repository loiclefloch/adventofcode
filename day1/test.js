...
const replaceStringDigitsFromStart = require("./index").replaceStringDigitsFromStart
const replaceStringDigitsFromEnd = require("./index").replaceStringDigitsFromEnd
...
test("replaceStringDigitsFromStart", () => {
  ...
  expect(replaceStringDigitsFromStart("64eight6eight6gxdpmtnbfone")).toBe("648686gxdpmtnbf1")
  expect(replaceStringDigitsFromStart("eightfour2fourvzksqhxmlkpkfktmdzpmthreetwonehv")).toBe("8424vzksqhxmlkpkfktmdzpm32nehv")
})

test("replaceStringDigitsFromEnd", () => {
  expect(replaceStringDigitsFromEnd("eightfour2fourvzksqhxmlkpkfktmdzpmthreetwonehv")).toBe("8424vzksqhxmlkpkfktmdzpm3tw1hv")
})
...
test("getCalibrationValue", () => {
  ...
  expect(getCalibrationValue("eightfour2fourvzksqhxmlkpkfktmdzpmthreetwonehv").total).toBe(81)
});
